...
//         // Dispatch the setCredentials action with user and token
//         dispatch(
//           setCredentials({ user: username, token: registerObj.data.token })
//         );
//         setError(null);

//         setSuccessMessage("You have signed up! Please log into your account!");

//         // console.log(registerObj.data.token);
...
//     try {
//       if (username !== "") {
//         const registerObj = await registerUser(username, password); // Call registerUser function
